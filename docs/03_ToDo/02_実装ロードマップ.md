...
- [ ] **C-01** OS / GPU ドライバ / 電源プロファイルの確認
- [ ] **C-02** Ollama インストール(winget)
- [ ] **C-03** `OLLAMA_*` 環境変数の永続化
- [ ] **C-04** 採用 3 モデル pull(qwen3-4b → llama3.2-3b → dolphin3-8b、計 ~10GB / 30〜60 分)
- [ ] **C-05** Python venv 作成 + 必須パッケージ(`pyyaml`, `requests`, `numpy`, `matplotlib` 等)
- [ ] **C-06** 初回ヘルスチェック(`ollama run` で 1 応答 + Uncensored の挙動を 1 件試す)
